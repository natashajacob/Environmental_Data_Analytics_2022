...
#We used a differnt argument in lessons == |
...
NTL.phys.Tuesday <- filter(NTL.phys.data, lakename == "Tuesday Lake")
NTL.1990to1999 <- filter(NTL.phys.Tuesday, year4 >= 1990 & year4 <= 1999)
```
...
#Alternate:  filter(daynum == 185 | daynum == 206) 
#instead of using daynum use month 
