...
Interpret the value of the categorical variable as something that you want to add to your model 
...
```{r}
# Modifying the same plot and adding legend.position = "none" to use in the final plot 
TemperatureByDepth_Plot1 <- ggplot(NTL_wrangled,
...
print(TemperatureByDepth_Plot1)

# Obtaining the legend from the first plot 
NTL_legend <- get_legend(TemperatureByDepth_Plot2)

#Making the final plot with the legend 
Combined_plot <- plot_grid(TemperatureByDepth_Plot1, NTL_legend, ncol = 1, nrow = 2, rel_heights = c(5, 0.3))
Combined_plot
```
