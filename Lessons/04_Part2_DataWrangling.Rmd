...
```
Join - you can use this to join datasets that dont match 
c bind and r bind - you can only use this if both datasets have the same number of rows and columns 
